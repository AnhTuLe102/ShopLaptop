...
import vn.tusleeshop.laptopshop.domain.Product_;
...
public class ItemController {
    ...
    public String deleteItemInCart(@PathVariable long id, HttpServletRequest request) {
        HttpSession session = request.getSession(false);
        long cartDetailId = id;
        this.productService.handleDeleteCartItem(cartDetailId, session);
    ...
    public String getProductPage(Model model, ProductCriteriaDTO productCriteriaDTO, HttpServletRequest request) {
        ...
        Page<Product> productPage = this.productService.fetchProducts(productCriteriaDTO, pageable);

        List<Product> listProducts = productPage.getContent().size() > 0 ? productPage.getContent()
