                    ...
                    <c:if test="${ empty cartDetails}">
                      <tr style="text-align: center; font-size: 24px;">
                        <td colspan="6">
                          ...
                          Giỏ hàng của bạn không có sản phẩm nào, hãy tiếp tục mua sắm nhé!
                        </td>
                      </tr>
                    </c:if>
                    ...
                    <div class="bg-light rounded">
                      <div class="p-4">
                        <h1 class="display-6 mb-4"
                          style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">Thông Tin Đơn
                          Hàng</span>
                        </h1>
