  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
      ...
      <head>
        ...
        <title>${product.name} - TLGear</title>
        <!-- Google Web Fonts -->
                ...
                <div class="row g-4">
                  ...
                  <div class="col-lg-6">
                    ...
                    <form action="/add-product-from-view-detail" method="post" modelAttribute="product">
                      ...
                      <input type="form-control d-none" type="text" value="${product.id}" name="id"
                        style="display: none;" />
                      <input type="form-control d-none" type="text" name="quantity" id="cartDetails0.quantity" value="1"
                        style="display: none;" />
